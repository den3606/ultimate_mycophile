-- This file Copy of data/scripts/magic/fungal_shift.lua
...
materials_from = {{
  ...
  probability = 1.0,
  materials = {"blood"},
}, -- NOTE(Olli): I'm not sure if it's a good idea to convert blood, because that often just feels buggy. but let's see.
{
  probability = 1.0,
  ...
  probability = 0.4,
  materials = {"acid_gas", "acid_gas_static", "poison_gas", "fungal_gas", "radioactive_gas", "radioactive_gas_static"},
  name_material = "acid_gas",
}, {
  probability = 0.4,
  materials = {"magic_liquid_polymorph", "magic_liquid_unstable_polymorph"},
  name_material = "magic_liquid_polymorph",
}, {
  probability = 0.4,
  materials = {"magic_liquid_berserk", "magic_liquid_charm", "magic_liquid_invisibility"},
}, {
  probability = 0.6,
  materials = {"diamond"},
}, {
...
log_messages = {"$log_reality_mutation_00", "$log_reality_mutation_01", "$log_reality_mutation_02", "$log_reality_mutation_03", "$log_reality_mutation_04", "$log_reality_mutation_05"}
